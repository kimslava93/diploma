...
namespace BOOM_GAMEBAR
{
    public partial class BOOM : Form
    {
        ...
        public BOOM()
        {
            ...
            InitializeComponent();
            staff_login_form staff_login_form = new BOOM_GAMEBAR.staff_login_form();
            staff_login_form.ShowDialog();
        }
        ...
        private void set_columns_names()
        {
            ...
            clients_table.Columns[1].HeaderText = column_time_start;
            clients_table.Columns[2].HeaderText = column_time_out;
            clients_table.Columns[3].HeaderText = column_table_num;
        ...
        {
            clients_connection = new SqlConnection(@"Server= (local)\SQLEXPRESS; Initial Catalog=BoomDB; Integrated Security=True;");
            clients_connection.Open();
            SqlDataAdapter data_adapter = new SqlDataAdapter("SELECT * FROM days_sessions_t", clients_connection);
